...
function Analytics() {
  ...
  return (
    <div id='purchases-analytics-info-holder' className='pt-8 flex justify-center text-black mx-2 sm:mx-0 '>
      <div id="flex-chart-center" className='min-w-[90%] sm:min-w-[95%] md:min-w-[85%]  xl:min-w-[80%] %] flex items-center rounded-md  flex-col bg-white mb-3'>
      <Input id={'select-year-for-analytics'} label={'Select-year'} value={year} inputType={'text'} placeholder={'ex:2024'} reminder={"*"} title={'please fill this field'} onchange={(e) =>{
          ...
          <div id="chart-tile" className='text-2xl font-semibold border border-black mt-7 shadow-md px-3 py-2 mx-1'>{`Month Wise Expenses in the year ${year}`}</div>
